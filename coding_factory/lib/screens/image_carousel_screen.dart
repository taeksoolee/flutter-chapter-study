...
class _ImageCarouselScreenState extends State<ImageCarouselScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: PageView(
        children: [
          Image.asset('asset/image_carousel/image_1.jpeg'),
          Image.asset('asset/image_carousel/image_2.jpeg'),
          Image.asset('asset/image_carousel/image_3.jpeg'),
          Image.asset('asset/image_carousel/image_4.jpeg'),
        ],
      ),
    );
  }
